...
knowing the symbols: known bits and unsigned and signed ranges, combined so that each part
tightens the others. Facts are always sound: every value the expression can take lies within
them.
